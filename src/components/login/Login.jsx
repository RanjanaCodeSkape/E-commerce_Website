...
const Login = () => {
  ...
  const { userAuthentication , loginWithRedirect  , isAuthenticated , logout} = useAuth0();
  console.log("current User" , userAuthentication)
...
const navigatetoHomePage = () =>{
  ...
  return (
    <>
    {isAuthenticated ? (<HomePage logout={logout}/> ): (
...
<path d="M9.25672 3.51711C10.4642 3.49331 11.6248 3.95743 12.4923 4.80235L14.9073 2.35088C13.3715 0.89904 11.3552 0.101717 9.25672 0.125518C6.06803 0.125518 3.14897 1.95817 1.71875 4.84995L4.52058 7.06341C5.18879 5.02846 7.05277 3.51711 9.25672 3.51711Z" fill="#EA4335"/>
   ...
   <div>
    <p>Didn't have an account? <Link to='/'>Sign Up</Link></p>
   </div>

        <button type="submit" className={styles.btnSignup} onClick={navigatetoHomePage}>Login</button>
        </div>
      </form>
    </div>
          )}
